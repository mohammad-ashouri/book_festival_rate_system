...
if ($_SESSION['head'] == 2 or $_SESSION['head'] == 3 or $_SESSION['head'] == 4) {
    ...
    if ($postInfo['ejmali2_ratercode_g1']!=$raterCode and $postInfo['ejmali1_ratercode_g1']!=$raterCode) {
        $query = mysqli_query($connection_book, "update posts set ejmali3_ratercode_g1='$raterCode',ejmali3_registrar_g1='$registrar',ejmali3_set_date_g1='$datewithtime' where id='$postID'");
        $operation = "Set Post For Rater3 Group1";
