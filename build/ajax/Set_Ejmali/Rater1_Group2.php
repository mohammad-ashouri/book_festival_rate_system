...
if ($_SESSION['head'] == 2 or $_SESSION['head'] == 3 or $_SESSION['head'] == 4) {
    ...
    if ($postInfo['ejmali2_ratercode_g2']!=$raterCode and $postInfo['ejmali3_ratercode_g2']!=$raterCode) {
        $query = mysqli_query($connection_book, "update posts set ejmali1_ratercode_g2='$raterCode',ejmali1_registrar_g2='$registrar',ejmali1_set_date_g2='$datewithtime' where id='$postID'");
        $operation = "Set Post For Rater1 Group2";
