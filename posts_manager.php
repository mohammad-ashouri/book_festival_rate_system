    ...
    <section class="content">
                            ...
                            <table style="width: 100%" class="table table-striped">
                                ...
                                <tr>
                                    ...
                                    <td id="scientificGroup1TD" hidden="hidden">
                                        <select name="scientificGroup1" id="scientificGroup1"
                                                class="form-control select2"
                                    ...
                                    <td id="scientificGroup2TD" hidden="hidden">
                                        <select name="scientificGroup2" id="scientificGroup2"
                                                class="form-control select2"
        ...
        <?php
            ...
            <div class="card card-warning">
                <div class="card-header">
                    <h3 class="card-title">
                        جشنواره فعال نیست. شما مجاز به ثبت اثر نیستید.
                    </h3>
                </div>
            </div>
        <?php endif; ?>
            ...
            <div class="card-header">
                <form action="#submitted_posts" method="get" style="display: flex" id="showPosts">
                    <h3 class="card-title">
                        ...
                        <button name="Search_Posts" id="Search_Posts" type="submit" class="btn btn-warning">جستجو
                        </button>
                    </h3>
                </form>
            </div>
                                    ...
                                    <center>
                                        <table style="" class="table table-striped">
                                            ...
                                            <tr>
                                                <th>ویژگی های اثر</th>
                                                <td colspan="5">
                                    <textarea name="propertiesForEdit" id="propertiesForEdit" class="form-control"
                                              rows="3"
                                              placeholder="ویژگی های اثر را وارد کنید."></textarea>
                                            ...
                                            <table style="width: 100%" class="table table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td id="scientificGroup1TD">
                                                        <select name="scientificGroup1ForEdit"
                                                                id="scientificGroup1ForEdit"
                                                                class="form-control select2"
                                                                title="گروه علمی اول را انتخاب کنید">
                                                            <option disabled selected>انتخاب کنید</option>
                                                            <?php
                                        ...
                                        <table style="width: 100%" class="table table-striped">
                                            <tr>
                                                <th colspan="6" style="text-align: center;background-color: #dee2e6">
                                                    اطلاعات صاحب اثر (در صورت تغییر اطلاعات، تمامی اطلاعاتی که با این کد
                                                    ملی ثبت شده اند تغییر خواهد کرد)
                                                </th>
                                            </tr>
                                            <tr>
                                                <th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" class="form-control"
                                                           placeholder="شماره پرونده حوزوی صاحب اثر را وارد کنید"
                                                           name="shparvandetahsiliForEdit"
                                                           id="shparvandetahsiliForEdit">
                                                </td>
                                            </tr>
                                        </table>
                                    </center>
