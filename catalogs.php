        ...
        <div class="card card-success">
            ...
            <div class="card-body">
                <table class="table table-bordered">
                    ...
                    ?>
                    <!--                                <option -->
                    <?php //if ($specials['active']==0) echo "disabled style='background-color: #ffc107'"
                    ?><!-->-->
                    ...
                    ?>
                    <!--                                <option -->
                    <?php //if ($service_locations['active']==0) echo "disabled style='background-color: #ffc107'"
                    ?><!-->-->
                    ...
                    ?>
                    <!--                                    <option value="-->
                    <?php //echo $mag_festival_position['id'];
                    ?><!--">-->
                    ...
                    ?>
                    <!--                                    <option value="-->
                    <?php //echo $mag_festival_scientific_committee['id'];
                    ?><!--">-->
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="publisher_subject" class="form-control select2" multiple
                                    id="publisher_subject" style="width: 100%;">
                                <?php
                                $query = mysqli_query($connection_book_signup, "select * from publishers order by title asc");
                        ...
                        <td>
                            <form action="build/php/inc/Add_Scientific_Committee.php" method="post"
                                  id="Scientific_Committee_Form">
                                <select name="Scientific_Committee_Subject" class="form-control select2"
                                        id="Scientific_Committee_Subject" style="width: 100%;">
                                    <option disabled selected>عنوان را انتخاب کنید</option>
                                    <?php
                                    $query = mysqli_query($connection_book_signup, "select * from publishers order by title asc");
                                    foreach ($query as $publishers):
                                        ...
                                        <option value="<?php echo $publishers['id']; ?>">
                                            <?php echo $publishers['subject']; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                                <br/><br/>
                                <input name="Scientific_Committee_Name" type="text" class="form-control"
                                       id="Scientific_Committee_Name" style="width: 50%;display: inline-block"
                                       placeholder="نام">
                                <input name="Scientific_Committee_Family" type="text" class="form-control"
                                       id="Scientific_Committee_Family" style="width: 49%;display: inline-block"
                                       placeholder="نام خانوادگی">
                                <br/><br/>
                                <input name="Scientific_Committee_National_Code" type="text" class="form-control"
                                       id="Scientific_Committee_National_Code" style="width: 49%;display: inline-block"
                                       placeholder="کد ملی">
                                <select name="Scientific_Committee_Position" id="Scientific_Committee_Position"
                                        class="form-control select2" style="width: 50%;display: inline-block">
                                    <option disabled selected>سمت را انتخاب کنید</option>
                                    <?php
                                    $query = mysqli_query($connection_book_signup, "select * from publishers order by title asc");
                                    foreach ($query as $publishers):
                                ...
                                <center>
                                    <button type="submit" class="btn btn-primary"
                                            onclick="return confirm('آیا از صحت اطلاعات وارد شده مطمئن هستید؟ پس از ورود قابل حذف نیست')">
                                        ثبت شورای علمی
                                    </button>
                                </center>
                            </form>
                            <br/>
                            <form action="build/php/inc/Disable_Scientific_Committee.php" method="post"
                                  id="Disable_Scientific_Committee_Form">
                                <select name="Scientific_Committee" id="Disable_Scientific_Committee"
                            ...
                            <br/>
                            <form action="build/php/inc/Enable_Scientific_Committee.php" method="post"
                                  id="Enable_Scientific_Committee_Form">
                                <select name="Scientific_Committee" id="Enable_Scientific_Committee"
                                        class="form-control select2" style="width: 100%;">
                                    <option disabled selected>کاربر را انتخاب کنید</option>
                                    <?php
                                    $query = mysqli_query($connection_variables, "select * from mag_festival_scientific_committee where active=0 order by family asc");
