...
--
-- Host: 127.0.0.1:3306
-- Generation Time: May 31, 2023 at 06:41 PM
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci COMMENT='Table for ejmali rates';

--
-- Dumping data for table `ejmali`
--

INSERT INTO `ejmali` (`id`, `article_code`, `r1`, `r2`, `r3`, `r4`, `sum`, `level`, `rater`, `rate_date`, `editor`, `edited_date`) VALUES
(1, 1, 1, 2, 3, 4, 10, 'ej1g1', '4', '1402/2/20 21:01:45', NULL, NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci COMMENT='Logs\nincludes:\n1- logins\n2- operations\n3- logouts';
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_persian_ci COMMENT='Table for All users.including:1- Raters2- Admins3- Headers4- Viewers';

--
-- Dumping data for table `users`
--

INSERT INTO `users` (`id`, `username`, `password`, `name`, `family`, `gender`, `national_code`, `phone`, `address`, `scientific_group`, `service_location`, `bank_name`, `shaba`, `bank_id`, `debit_card_id`, `type`, `approved`, `registrar`, `date_added`, `editor`, `edited_date`) VALUES
(1, 'superadmin', '$argon2i$v=19$m=65536,t=4,p=1$NU52RExRekEzd2dPM1RwLg$kfO/AgItBI2wqTtyExlEwazmcDjZa6eGuz27JN9X4Qs', 'محمد', 'عاشوری', 'مرد', '0371714941', '09398888226', 'قم سی متری قائم', NULL, NULL, NULL, '3453453453', NULL, 3453545, '4', 1, '', '', NULL, NULL);
COMMIT;
