...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">ویرایش صاحب اثر</h1>
            @if (count($errors) > 0)
            ...
            <div class="bg-white rounded shadow flex flex-col ">
                {!! Form::model($person, ['method' => 'PATCH','id'=>'edit-person','route' => ['Person.update', $person->id]]) !!}
                @csrf
                    ...
                    <div class="flex mt-4">
                        <div class="flex-1 flex-col items-right mb-2 ml-3">
                            ...
                            <input type="text" autocomplete="off" required id="first_name" name="first_name"
                                   ...
                                   value="{{$person->generalInformationInfo->first_name}}"
                        ...
                        <div class="flex-1 flex-col items-right mb-2 ml-3">
                            ...
                            <input type="text" autocomplete="off" required id="last_name" name="last_name"
                                   class="border rounded-md w-full mb-2 px-3 py-2 text-right"
                                   value="{{ $person->generalInformationInfo->last_name }}"
                    ...
                    <div class="flex">
                        <div class="flex-1 flex-col items-right mb-2 ml-3">
                            ...
                            <input type="text" autocomplete="off" required id="national_code" name="national_code"
                                   class="border rounded-md w-full mb-2 px-3 py-2 text-right"
                                   value="{{ $person->generalInformationInfo->national_code }}"
                        ...
                        <div class="flex-1 flex-col items-right mb-2 ml-3">
                            ...
                            <input type="text" autocomplete="off" required id="mobile" name="mobile"
                                   class="border rounded-md w-full mb-2 px-3 py-2 text-right"
                                   value="{{ $person->generalInformationInfo->mobile }}"
                    ...
                    <div class="flex">
                        <div class="flex-1 flex-col items-right mb-2 ml-3">
                            ...
                            <select id="gender" required class="border rounded-md w-full px-3 py-2 "
                                    name="gender">
                                <option @if($person->generalInformationInfo->gender=='مرد') selected @endif value="مرد">
                                    مرد
                                </option>
                                <option @if($person->generalInformationInfo->gender=='زن') selected @endif value="زن">
                                    زن
                                </option>
                            </select>
                        </div>
                        <div class="flex-1 flex-col items-right mb-2 ml-3">
                            ...
                            <input type="text" id="howzah_code" name="howzah_code" required
                                   autocomplete="off" value="{{ $person->generalInformationInfo->howzah_code }}"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    <input value="{{$person->id}}" name="id" type="hidden">
                    <button type="submit"
