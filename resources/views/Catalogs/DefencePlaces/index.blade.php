...
@section('content')
    <main class="flex-1 bg-gray-100 py-6 px-8">
        <div class="mx-auto lg:mr-72">
            <h1 class="text-2xl font-bold mb-4">تعاریف اولیه - مدیریت بر اطلاعات محل دفاع</h1>
            ...
            <div class="bg-white rounded shadow p-6 flex flex-col ">
                ...
                <table class="w-full border-collapse rounded-lg overflow-hidden text-center datasheet">
                    ...
                    <tr class="bg-gradient-to-r from-blue-400 to-purple-500 items-center text-center text-white">
                        ...
                        <th class="px-6 py-3  font-bold ">نام محل دفاع</th>
                    ...
                    @foreach ($defencePlaces as $defencePlace)
                        <tr class="bg-white">
                            ...
                            <td class="px-6 py-4">{{ $defencePlace->name }}</td>
                            <td class="px-6 py-4">
                                @if($defencePlace->status==1)
                                    فعال
                                @else
                                    غیرفعال
                                @endif
                            ...
                            <td class="px-6 py-4">
                                <a href="{{route('DefencePlaces.edit',$defencePlace->id)}}">
                                    <button type="button"
