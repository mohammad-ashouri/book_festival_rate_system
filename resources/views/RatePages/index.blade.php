            ...
            <div class="bg-white rounded shadow p-6">
                ...
                <table class="w-full border-collapse rounded-lg overflow-hidden text-center mt-3">
                    ...
                    <tr class="items-center text-center ">
                        ...
                        <td class="px-6 py-1 bg-gray-300">
                            <select id="type" class="border rounded-md w-80 px-3 py-2"
                                    name="type">
                                <option value="" disabled selected>انتخاب کنید</option>
                                <option value="اثر مربوط به گروه حاضر است">اثر مربوط به گروه حاضر است</option>
                                <option value="اثر میان رشته ای است">اثر میان رشته ای است (گروه مرتبط تعیین شود)</option>
                                <option value="اثر مربوط به گروه حاضر نیست">اثر مربوط به گروه حاضر نیست (گروه مرتبط تعیین شود)</option>
                            </select>
                        </td>
                    </tr>
                </table>
