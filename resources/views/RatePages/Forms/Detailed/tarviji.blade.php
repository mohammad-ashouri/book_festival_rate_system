<table id="rateForm" class="w-full border-collapse rounded-lg overflow-hidden text-center mt-3">
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تناسب موضوع با نیازهای علمی-فرهنگی جامعه</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>استفاده از منابع معتبر و قدرت بهره وری از آنها</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>ساختار و نظام هندسی کتاب (هماهنگی فصول و بخش های مختلف کتاب، سبک و سیاق و شیوه نتیجه گیری از مطالب)</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تتبع و نقل صحیح علمی و قدرت نقد و بررسی آراء</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>زاویه دید و نگاه جدید به مسائل</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>ابتکار و نوآوری در طرح مسائل و شیوه استدلال</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تناسب سطح علمی کتاب با مخاطب</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>پرهیز از مطالب تکراری، کلیشه ای و حاشیه ای</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>رعایت اصول و فرهنگ تبلیغ نوشتاری (نرمی بیان و سادگی زبان، پرهیز از عبارات تند و شعاری، ایراد مثال های
                گویا و استدلال های متعدد، قدرت تفهیم، پرورش مطلب با استفاده از منابع مقبول و مسلم، درگیر کردن ذهن مخاطب
                با موضوع، استفاده از موجهات تاریخی، مدنی، فرهنگی و اجتماعی و...)</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>توفیق ارتباط با مخاطب و جذابیت اثر</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>ناظر بودن به تحقیقات و آثار پیشین و رفع اشکالات آن ها</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>قدرت پاسخگویی به شبهات علمی و شایع در جامعه</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
...
<script>
    ...
    $('#DetailedAssessmentSet').on('submit', function (e) {
        ...
        if (r1_point.value === '') {
        ...
        } else if (r3_point.value < 0 || r3_point.value > 5) {
        ...
        } else if (r4_point.value < 0 || r4_point.value > 10) {
        ...
        } else if (r6_point.value < 0 || r6_point.value > 6) {
        ...
        } else if (r8_point.value < 0 || r8_point.value > 2) {
        ...
        } else if (r10_point.value < 0 || r10_point.value > 5) {
            ...
            swalFire('خطا!', 'امتیاز ردیف یازدهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r13_point.value < 0 || r13_point.value > 5) {
            swalFire('خطا!', 'امتیاز ردیف یازدهم اشتباه وارد شده است.', 'error', 'تلاش مجدد');
        } else if (r13_description.value == null || r13_description.value == '') {
            swalFire('خطا!', 'توضیحات امتیاز ردیف یازدهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r14_point.value === '') {
            swalFire('خطا!', 'امتیاز ردیف یازدهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r14_point.value < 0 || r14_point.value > 5) {
            swalFire('خطا!', 'امتیاز ردیف یازدهم اشتباه وارد شده است.', 'error', 'تلاش مجدد');
