<table id="rateForm" class="w-full border-collapse rounded-lg overflow-hidden text-center mt-3">
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>اولویت و میزان تاثیر مساله تحقیق در تامین نیازهای فرهنگی و علمی همگانی یا جوامع علمی</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>نقل صحیح آراء و اسناد به منابع معتبر، اصیل و متنوع</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>میزان بهره گیری از مستندات و منابع و نتیجه گیری</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تحلیل و تصحیح آراء و نقد آن</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>میزان دستیابی پایان نامه به اهداف خود</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تحدید دقیق مساله دقیق و تبیین هدف، سوالات و فرضیه ها</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>به کارگیری روش متناسب با مساله</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    {{--    ردیف دهم--}}
    <tr class="items-center text-center ">
        <td class="px-6 py-1 bg-gray-300" rowspan="4">
    ...
    <tr class="items-center text-center ">
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>3/2- روش تحقیق و زاویه نگرش به مساله</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تناسب ساختار و انسجام منطقی سرفصل ها و توازن حجم مطالب فصول</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>توازن حجم مطالب بخش ها و فصول</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p class="font-bold">ویژگیهای ادبی پایان نامه، در این قسمت منظور نمی شود.</p>
            <p>امتیاز خاص این اثر که در معیارهای مندرج در فرم ذکر نشد مانند ارائه راهکارهای عملی مناسب، ایجاد چشم انداز
                نوین، اثربخشی فوق العاده و...</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p class="font-bold">1- رعایت اخلاق در نقل و نقد</p>
            <p class="font-bold">2- روانی و گویایی متن و پرهیز از واژه های نامانوس، پیچیده و غیرفصیح</p>
            <p class="font-bold">3- اغلاط انشایی و املایی</p>
            <p class="font-bold">4- تناسب زبان متن با موضوع</p>
            <p class="font-bold">5- تنظیم فنی پاورقی ها و کتابنامه</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
...
<script>
    $('#r1_point, #r2_point, #r3_point, #r4_point, #r5_point, #r6_point, #r7_point, #r8_point, #r9_point, #r10_point, #r11_point, #r12_point, #r13_point, #r14_point, #r15_point, #r16_point').on('input', function () {
        if (!isNaN($(this).val())) {
            ...
            $('#Sum').text(r1 + r2 + r3 + r4 + r5 + r6 + r7 + r8 + r9 + r10 + r11 + r12 + r13 + r14 + r15 + r16);
        }
    });
    ...
    $('#DetailedAssessmentSet').on('submit', function (e) {
        ...
        if (r1_point.value === '') {
        ...
        } else if (r1_point.value < 0 || r1_point.value > 8) {
        ...
        } else if (r5_point.value < 0 || r5_point.value > 6) {
        ...
        } else if (r6_point.value < 0 || r6_point.value > 4) {
        ...
        } else if (r8_point.value < 0 || r8_point.value > 8) {
        ...
        } else if (r9_point.value < 0 || r9_point.value > 4) {
        ...
        } else if (r10_point.value < 0 || r10_point.value > 8) {
            ...
            swalFire('خطا!', 'امتیاز ردیف دوازدهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r12_point.value < 0 || r12_point.value > 6) {
            swalFire('خطا!', 'امتیاز ویژه ردیف دوازدهم وارد شده است.', 'error', 'تلاش مجدد');
        } else if (r12_description.value == null || r12_description.value == '') {
            swalFire('خطا!', 'توضیحات امتیاز ردیف دوازدهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r13_point.value === '') {
            swalFire('خطا!', 'امتیاز ردیف سیزدهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r13_point.value < 0 || r13_point.value > 2) {
            swalFire('خطا!', 'امتیاز ردیف سیزدهم اشتباه وارد شده است.', 'error', 'تلاش مجدد');
        } else if (r13_description.value == null || r13_description.value == '') {
            swalFire('خطا!', 'توضیحات امتیاز ردیف سیزدهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r14_point.value === '') {
            swalFire('خطا!', 'امتیاز ردیف چهاردهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r14_point.value < 0 || r14_point.value > 2) {
            swalFire('خطا!', 'امتیاز ردیف چهاردهم اشتباه وارد شده است.', 'error', 'تلاش مجدد');
        } else if (r14_description.value == null || r14_description.value == '') {
            swalFire('خطا!', 'توضیحات امتیاز ردیف چهاردهم وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r15_point.value === '') {
            swalFire('خطا!', 'امتیاز ویژه وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r15_point.value < 0 || r15_point.value > 5) {
            ...
            swalFire('خطا!', 'امتیاز ادبی وارد نشده است.', 'error', 'تلاش مجدد');
        } else if (r16_point.value < 0 || r16_point.value > 10) {
            swalFire('خطا!', 'امتیاز ادبی اشتباه وارد شده است.', 'error', 'تلاش مجدد');
        } else if (r16_description.value == null || r16_description.value == '') {
            swalFire('خطا!', 'توضیحات امتیاز ادبی وارد نشده است.', 'error', 'تلاش مجدد');
