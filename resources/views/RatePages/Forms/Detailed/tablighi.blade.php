<table id="rateForm" class="w-full border-collapse rounded-lg overflow-hidden text-center mt-3">
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>میزان اولویت و تاثیر موضوع در تامین نیازهای فرهنگی همگانی یا قشرهای خاص</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>میزان جدید و نو بودن محتوا و مطالب و یا جدید بودن نحوه ارائه مطالب</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>میزان ارتباط اثر با عناصر مورد اشاره در تعریف فرهنگ یا تبلیغ</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>بهره گیری صحیح و متناسب از آراء و منابع معتبر</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>میزان اثربخش بودن در یکی از حوزه های معرفت افزایی، توانمندسازی یا مهارت آموزی</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>توفیق اثر در جذب و جلب نظر مخاطب (همگانی یا قشر خاص)</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        <td class="px-6 py-1 bg-gray-300" rowspan="4">
            1- خلاقیت و نوآوری در:
        </td>
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>1/1- روش تدوین و زاویه نگرش به موضوع</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>1/2- طراحی، پرداخت موضوع و جذاب سازی اثر</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>به کارگیری روش متناسب با موضوع</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>انسجام منطقی سرفصل ها و عناوین</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تناسب حجم مطالب بخشها و فصول بر اساس هدف اصلی اثر</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>میزان بهره گیری از پیرایه های هنری(عکس، نمودار و...)، ادبی (شعر، حکایت و...)و سایر پیرایه های موثر در نشر
                آثار فرهنگی تبلیغی</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
...
<script>
    ...
    $('#DetailedAssessmentSet').on('submit', function (e) {
        ...
        } else if (r3_point.value < 0 || r3_point.value > 7) {
