<table id="rateForm" class="w-full border-collapse rounded-lg overflow-hidden text-center mt-3">
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>رعایت استانداردهای کتابشناختی/فهرست نگاری</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>اهمیت موضوع کتابشناسی/فهرست نگاری</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>ساختار مناسب (تبویب و تنظیم منطقی)</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>نو بودن اثر یا امتیاز آن نسبت به آثار مشابه</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>تنظیم فنی و دقیق کتابنامه و پاورقی ها</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p>پیوست انواع فهرست ها و نمایه های دقیق</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p class="font-bold">آراستگی زبان</p>
            <p>9-1 آرایه های لفظی و معنوی (حسن مطلع، حسن مقطع، همخوانی/مراعات نظیر، تشبیه، لف و نشر، هماوایی و...)</p>
            <p>9-2 سادگی و روانی قلم </p>
            <p>9-3 تنوع واژگانی </p>
            <p>9-4 صمیمی و زنده نویسی </p>
            <p>9-5 بهداشت قلم (پرهیز از گرته برداری، کلیشه، تعابیر و کلمات سست، درازنویسی، ایجاد مخل و اطناب ممل، اغلاط
                انشایی، دشوار نویسی، پیچیدگی کلامی، واژه های غیرفصیح و...) </p>
            <p>9-6 تکیه بر استفاده از فعل خاص و معلوم </p>
            <p>9-7 عنوان کتاب </p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p class="font-bold">ویراستگی لفظی</p>
            <p>10-1 رسم الخط</p>
            <p>10-2 علائم سجاوندی</p>
            <p>10-3 پرهیز از اغلاط دستوری</p>
            <p>10-4 قطع و وصل ها</p>
            <p>10-5 پاراگراف بندی</p>
            <p>10-6 یکدستی</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
    ...
    <tr class="items-center text-center ">
        ...
        <td class="px-6 py-1 bg-gray-300 text-sm">
            <p class="font-bold">رعایت امور فنی و صوری</p>
            <p>11-1 طرح جلد</p>
            <p>11-2 صفحه آرایی</p>
            <p>11-3 حروف چینی</p>
            <p>11-4 فصل بندی</p>
            <p>11-5 تیترسازی</p>
            <p>11-6 عناوین سر صفحه ای</p>
            <p>11-7 غلط گیری دقیق</p>
        </td>
        <td class="px-6 py-1 bg-gray-300">
            <input
                class="shadow appearance-none border rounded py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:ring-blue-500 focus:border-blue-500 w-20 mt-2 text-center"
...
<script>
    ...
    $('#DetailedAssessmentSet').on('submit', function (e) {
        ...
        } else if (r1_point.value < 0 || r1_point.value > 14) {
        ...
        } else if (r2_point.value < 0 || r2_point.value > 12) {
        ...
        } else if (r4_point.value < 0 || r4_point.value > 12) {
        ...
        } else if (r9_point.value < 0 || r9_point.value > 6) {
        ...
        } else if (r10_point.value < 0 || r10_point.value > 6) {
